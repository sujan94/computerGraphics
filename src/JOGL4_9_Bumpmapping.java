...
public class JOGL4_9_Bumpmapping extends JOGL4_7_TexObjects {
	...
	public void init(GLAutoDrawable drawable) {
		...
		vShaderSource = readShaderSource("src/JOGL4_9_V.shader"); // read vertex shader
		fShaderSource = readShaderSource("src/JOGL4_9_F.shader"); // read fragment shader
