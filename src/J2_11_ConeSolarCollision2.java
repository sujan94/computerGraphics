...
public class J2_11_ConeSolarCollision2 extends JOGL2_11_ConeSolar
{
    // direction and speed of rotation
    static float coneD = WIDTH / 110000;

    static float sphereD = -WIDTH / 640000;

    static float cylinderD = WIDTH / 30000f;

    static float spherem = 0.00120f, cylinderm = 0.00240f;
    ...
    {
        J2_11_ConeSolarCollision2 f = new J2_11_ConeSolarCollision2();
