...
public class JOGL3_2_Emission extends JOGL2_13_TravelSolar {
  
	  float M_emission[] = {0.4f, 0.4f, 0.4f, 1}; // Material property: emission 
	  ...
	  public void init(GLAutoDrawable drawable) {
			...
			vShaderSource = readShaderSource("src/JOGL3_2_V.shader"); // read vertex shader
