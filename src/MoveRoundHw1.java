...
public class MoveRoundHw1  extends JOGL1_1_PointVFfiles {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if(pos> -RADIUS && !isClockWiseDirection) {
            pos = pos-0.005f;
            posy = (float) Math.sqrt(RADIUS*RADIUS-(pos*pos));
        }else if (pos == RADIUS) {
            posy = 0.0f;
            ...
            pos = pos+0.005f;
            posy = -1 * (float) Math.sqrt(RADIUS*RADIUS-(pos*pos));
        }
        ...
        //Connect JOGL variable with shader variab`le by name
