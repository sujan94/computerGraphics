...
void	main(void)	{	
    ...
    if (dCone==1) fColor = 0.4*fColor + 0.6*texture(vseTex, tc); // integrate color and texture
    else fColor = 0.2*fColor +  + 0.8*texture(gmuTex, tc1); // integrate color and texture
