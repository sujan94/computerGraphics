...
public class JOGL2_0_2DTransformTest extends JOGL1_4_5_Circle {
...
//            , {2.0f, 1.0f, 0.0f}};
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        transDrawTriangle1(vdata);

        myLoadIdentity();
//        myScalef((float) cnt/200f, (float) cnt/200f, 1f);
//        transDrawTriangle(vdata);
    ...
    // the vertices are transformed first then drawn
    public void transDrawTriangle1(float[] v1) {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        vShaderSource = readShaderSource("srcp/JOGL2_0_V.shader"); // read vertex shader
        fShaderSource = readShaderSource("srcp/JOGL2_0_F.shader"); // read fragment shader
    ...
    public static void main(String[] args) {
        JOGL2_0_2DTransformTest f = new JOGL2_0_2DTransformTest();
